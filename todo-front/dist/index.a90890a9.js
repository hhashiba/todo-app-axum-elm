...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$Todo = F2(function(text, completed) {
        return {
            completed: completed,
            text: text
        };
    ...
    var $author$project$Main$todoDecoder = A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, "completed", $elm$json$Json$Decode$bool, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, "text", $elm$json$Json$Decode$string, $elm$json$Json$Decode$succeed($author$project$Main$Todo)));
    ...
    var $author$project$Main$fetchTodos = $elm$http$Http$get({
        expect: A2($elm$http$Http$expectJson, A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$TodosReceived), $author$project$Main$todosDecoder),
        url: $author$project$Main$dbUrl
    });
    var $author$project$Main$init = function(_v0) {
        return _Utils_Tuple2({
            input: "",
            todos: $krisajenkins$remotedata$RemoteData$Loading
        }, $author$project$Main$fetchTodos);
    };
    ...
    var $author$project$Main$view = function(model) {
        return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
            ...
            function() {
                ...
                switch(_v0.$){
                    case "Loading":
                        return A2($elm$html$Html$h2, _List_Nil, _List_fromArray([
                    ...
                    case "Success":
                        ...
                        return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                            $author$project$Main$viewHeader,
                            A2($elm$html$Html$ul, _List_Nil, $author$project$Main$viewTodos(payload))
                        ]));
                    case "NotAsked":
                        return $elm$html$Html$text("NotAsked!!");
                    default:
                        var httpError = _v0.a;
                        return $elm$html$Html$text($author$project$Main$buildErrorMessage(httpError));
                }
            }()
        ]));
    };
...
//# sourceMappingURL=index.a90890a9.js.map
